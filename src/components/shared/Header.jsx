...
const Header = () => {
  return (
    <>
      <div className="flex items-center justify-between px-4 sm:px-8 md:px-20 py-2 bg-black">
        {/* Logo */}
        <img src={logo} alt="Logo" className="h-8 sm:h-10 md:h-12" />

        {/* Sign in button */}
        <button className="px-4 py-2 text-white rounded flex items-center">
          <svg xmlns="http://www.w3.org/2000/svg" width="auto" height="auto" viewBox="0 0 150 53" fill="none" className="h-10 sm:h-12 md:h-14">
            <path
